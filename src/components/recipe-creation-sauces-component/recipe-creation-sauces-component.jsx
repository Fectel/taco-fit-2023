...
export default function RecipeCreationSaucesComponent({recipeAddOnsList, setRecipeAddOnsList, recipeId}){
...
function SaucesSearchComponent({setRecipeCreationAddOnsComponentState, recipeAddOnsList, setRecipeAddOnsList}){
    ...
    async function loadAndFilterData(e) {
        ...
        loadedData = await loadAnyCollectionData('recipes-sauces-collection');
...
/// this page has to be like the create new recipe page because each sauce if its homemade has a recipe so you can add to this
/// collectioneiterh by nutrition facts or create the recipe
function AddSaucesComponent({recipeId,
    ...
    async function onSaveIngredientClick() {
        ...
        let bool = await addObjectToAnyCollection(ingredientData, `recipes-sauces-collection`)
